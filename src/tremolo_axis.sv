...
// ============================================================================
// tremolo_axis.sv — AXI-Stream wrapper for the original tremolo.sv core
// Instantiates tremolo.sv internally.  Mono effect: L processed, replicated to R.
// ============================================================================
